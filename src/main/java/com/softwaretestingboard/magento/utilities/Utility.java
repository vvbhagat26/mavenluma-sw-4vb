...
//*************************** Action Methods ***************************************//
    ...
    public List<String> afterFilterProductNames(By by) {
        ...
        List<WebElement> afterFilterProductNames = getListOfElements(by);
    ...
    public List<Double> convertPriceListToReverse(By by) {
        List<WebElement> beforeFilterProductPrice = getListOfElements(by);
        //Create arraylist
    ...
    public List<Double> afterFilterPrice(By by) {
        //Store elements after filtering
        List<WebElement> afterFilterProductPrice = getListOfElements(by);
